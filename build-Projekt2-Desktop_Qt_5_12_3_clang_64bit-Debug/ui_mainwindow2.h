...
public:
    ...
    void setupUi(QMainWindow *MainWindow2)
    {
        ...
        Savetofile->setGeometry(QRect(0, 700, 1391, 51));
        QFont font1;
        ...
        Wyjcie->setGeometry(QRect(0, 750, 1391, 51));
        Wyjcie->setFont(font1);
        stanKontsa = new QLabel(tab_5);
        stanKontsa->setObjectName(QString::fromUtf8("stanKontsa"));
        stanKontsa->setGeometry(QRect(540, 580, 301, 51));
        QFont font2;
        ...
        SalonInfo->setGeometry(QRect(0, 650, 1391, 51));
